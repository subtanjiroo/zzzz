...
class CustomField extends Component {
    static template = xml`
        <div id="chatbox_wrapper">
            ...
            <div id="sidebar" t-att-class="state.showSidebar ? 'show' : ''">
                ...
                <ul id="task_list">
                    <li t-on-mouseenter="handleMouseEnter" t-on-click="HistoryBar" t-on-mouseleave="handleMouseLeave" t-foreach="tasks" t-as="task" t-key="task">
            ...
            <div id="chatbox">
                ...
                <div id="CHAT_INPUT">
                    <button name="Upload" type="button" id="upload_button" t-on-click="UploadHandle">@</button>
    ...
    setup() {
        this.state = useState({ showSidebar: true }); // Trạng thái hiển thị sidebar
        this.messageState = useState({ message: "" }); // State lưu trữ tạm thời tin nhắn
        this.tasks = ['task1', 'task2', 'task3']; // Mảng chứa danh sách các task
    }
...
/* Nut Tam Thoi De Test Giao Dien */
    async sendMessage() {
